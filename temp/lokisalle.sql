...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 22 Février 2017 à 12:30
...
CREATE TABLE `avis` (
  ...
  `note` int(2) NOT NULL,
  `date_eregistrement` datetime NOT NULL
...
CREATE TABLE `produit` (
  ...
  `prix` int(3) NOT NULL,
  `etat` enum('Libre','Reservée') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `commande`
  ...
  ADD CONSTRAINT `commande_ibfk_2` FOREIGN KEY (`id_produit`) REFERENCES `produit` (`id_produit`) ON DELETE NO ACTION ON UPDATE NO ACTION;
