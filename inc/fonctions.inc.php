...
// Calculer le nbr de produits dans le panier
...
// pour ce faire il faut reperer l'indice (sa position) du produit dans l'array id_produit
// et ensuite on supprime cet indice (sa position dans l'array) dans tous les autres array
